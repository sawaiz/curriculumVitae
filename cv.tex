...
\maintitle{\href{http://sawaizsyed.com/}{Sawaiz Syed}}{} %{Last update on \today}
...
\noindent\href{mailto:sawaiz@sawaizsyed.com}{sawaiz\mbox{}@\mbox{}sawaizsyed.com}\sbull
678-457-2610\sbull
%{sawaiz.syed} \emph{(Skype)}\sbull
\href{http://www.linkedin.com/in/sawaizsyed}{LinkedIn}\sbull
%\\
190 Lembeth Ct. 30004
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    ...
    {\bodytext{Design of a low power embedded system mesh to communicate 
    ...
    systems. Reducing cost of final product by 80 \% for production. 
    Develop Software using C, C++. Write documentation for future 
...
\headedsection
  ...
  \headedsubsection
    ...
    {\bodytext{Ported Atmel \href{http://www.microsoft.com/net/multiple-platform-support}{.Net Microframework}
     for over the air reprogramming. Constructed 
	and maintained prototyping equipment including an aluminum forge and a 3D 
	printer. Tested and debugged failed hardware. Researched materials for
	future improvement of products. Produced and tested field electronics.}}
}
...
\headedsection
  ...
  \headedsubsection
    ...
    Maintained clean and safe environment as required by standards. Aided customers with finding and purchasing products.}}
}
...
\roottitle{Achievements}
  {\href{https://www.citiprogram.org/}{\acr{CITI}} Responsible Conduct of Research certification, 
  	Amateur Radio Technician License (\href{http://wireless2.fcc.gov/UlsApp/UlsSearch/license.jsp?licKey=3657450}{KM4GRB}),
%  \acr{AP} Scholar with Distinction (6 Exams), 
